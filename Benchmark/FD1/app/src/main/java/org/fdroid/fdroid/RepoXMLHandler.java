...
public class RepoXMLHandler extends DefaultHandler {
    ...
    protected void getIcon(DB.App app) {
        try {
            ...
            StringBuilder builder = new StringBuilder((CharSequence) Environment.getExternalStorageDirectory()).append('/').append(mctx.getString(R.string.icons_path));
...
//                f.delete();
            try (
                    FileOutputStream saveit = (FileOutputStream) Files.newOutputStream(Paths.get(f.getName()), StandardOpenOption.WRITE);
